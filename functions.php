<?php
/**
 * forelektrik_theme functions and definitions
 *
...
function forelektrik_theme_setup() {
	/*
		...
		* If you're building a theme based on forelektrik_theme, use a find and replace
		* to change 'forelektrik_theme' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'forelektrik_theme', get_template_directory() . '/languages' );
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'forelektrik_theme_custom_background_args',
			array(
...
function forelektrik_theme_scripts() {
	...
	wp_style_add_data( 'forelektrik_theme-style', 'rtl', 'replace' );
